...
!function(a){Drupal.behaviors.sunrun_hero_video={attach:function(b,c){var d=(c.sunrun_hero_video.video_url,a(".banner .body a.btn"),a(".layout-full .bg-image img").outerHeight()),e=a(".layout-full .play-overlay img");a(window).resize(function(){a(window).width()<=1024?(d=a(".layout-full .bg-image img.mobile").outerHeight(),e.css("top",d/2)):e.css("top","50%")}),a(window).resize()}}}(jQuery);;
/*!
